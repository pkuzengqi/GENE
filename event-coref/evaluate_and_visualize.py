...
from utils import RunningAverage, get_configs, flatten
...
def evaluate_and_visualize(config_name, model_path, output_path, gene_variant=None):
...
if __name__ == "__main__":
    ...
    # Start training
    evaluate_and_visualize(args.config_name, args.model_path, args.output_path, args.gene_variant)
